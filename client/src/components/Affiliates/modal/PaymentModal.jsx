    ...
    <div className='modelpayment'>
      <Modal show={showModal} onHide={hideModal} style={{width:"100vw"}}>
        ...
        {projects.map((data,index)=>(
            ...
            <p style={{fontWeight:750}} className='fs-5 '>Beneficiary Name: <span style={{fontWeight:600}}>{data.nameBeni}</span></p>
            <p style={{fontWeight:750}} className='fs-5'>Account Number:<span style={{fontWeight:600}}>  {data.account}</span></p>
            <p style={{fontWeight:750}} className='fs-5'>Bank Address: <span style={{fontWeight:600}}>{data.beniAddress}</span></p>
            <p style={{fontWeight:750}} className='fs-5'>Sort Code:span <span style={{fontWeight:600}}>{data.sortCode}</span></p>
